...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Core.DataLayer.Model.Temporary.LogElement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessActivity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessActivityData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessDiagnosticData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessExternalData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessInstanceContainer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessStateData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ProcessResultFullSerialization")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessStepHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessActivity", b =>
                {
                    b.HasOne("Cvl.ApplicationServer.Processes.Core.Model.ProcessActivityData", "ProcessActivityData")
                        .WithMany()
                        .HasForeignKey("ProcessActivityDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cvl.ApplicationServer.Processes.Core.Model.ProcessInstanceContainer", "ProcessInstance")
                        .WithMany()
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessDiagnosticData", b =>
                {
                    b.HasOne("Cvl.ApplicationServer.Processes.Core.Model.ProcessInstanceContainer", "ProcessInstance")
                        ...
                        .HasForeignKey("Cvl.ApplicationServer.Processes.Core.Model.ProcessDiagnosticData", "ProcessInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessExternalData", b =>
                {
                    b.HasOne("Cvl.ApplicationServer.Processes.Core.Model.ProcessInstanceContainer", "ProcessInstance")
                        ...
                        .HasForeignKey("Cvl.ApplicationServer.Processes.Core.Model.ProcessExternalData", "ProcessInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessInstanceContainer", b =>
                {
                    b.OwnsOne("Cvl.ApplicationServer.Processes.Core.Model.OwnedClasses.ExternalIdentifiers", "ExternalIds", b1 =>
                        {
                    ...
                    b.OwnsOne("Cvl.ApplicationServer.Processes.Core.Model.OwnedClasses.ProcessBusinessData", "BusinessData", b1 =>
                        {
                            b1.Property<long>("ProcessInstanceContainerId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("Cvl.ApplicationServer.Processes.Core.Model.OwnedClasses.ProcessSpecificData", "ProcessSpecificData", b1 =>
                        {
                            b1.Property<long>("ProcessInstanceContainerId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("Cvl.ApplicationServer.Processes.Core.Model.OwnedClasses.ProcessThreadData", "ThreadData", b1 =>
                        {
                            b1.Property<long>("ProcessInstanceContainerId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("Cvl.ApplicationServer.Processes.Core.Model.OwnedClasses.ProcessTypeData", "ProcessTypeData", b1 =>
                        {
                            b1.Property<long>("ProcessInstanceContainerId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("Cvl.ApplicationServer.Processes.Core.Model.OwnedClasses.ProcessStepData", "Step", b1 =>
                        {
                            b1.Property<long>("ProcessInstanceContainerId")
                                .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessStateData", b =>
                {
                    b.HasOne("Cvl.ApplicationServer.Processes.Core.Model.ProcessInstanceContainer", "ProcessInstance")
                        ...
                        .HasForeignKey("Cvl.ApplicationServer.Processes.Core.Model.ProcessStateData", "ProcessInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cvl.ApplicationServer.Processes.Core.Model.ProcessStepHistory", b =>
                {
                    b.HasOne("Cvl.ApplicationServer.Processes.Core.Model.ProcessInstanceContainer", "ProcessInstanceContainer")
